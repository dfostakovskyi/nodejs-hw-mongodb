...
export const getContacts = async (userId, page, perPage, sortField, sortOrder, filters) => {
    ...
    const [contacts, count] = await Promise.all([
        ContactsCollection.find(filterConditions).sort(sortOptions).skip(skip).limit(perPage),
